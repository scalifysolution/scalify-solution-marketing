...
const promises = [
  {
    icon: Bot,
    title: "AI Does the Follow-ups",
    desc: "Your CRM calls, messages & follows up — automatically.",
  },
  {
    icon: Zap,
    title: "Zero Manual Work",
    desc: "From lead capture to deal close — fully automated.",
  },
  {
    icon: TrendingUp,
    title: "More Leads, More Sales",
    desc: "AI finds patterns humans miss. Watch conversions rise.",
  },
];
...
const CrmHeroSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...
      subject: String(fd.get("subject") || "CRM Development Inquiry"),
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-start lg:items-center section-padding pt-32 overflow-hidden">
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-8 md:gap-12 items-start relative z-10">
        <div className="flex flex-col justify-center lg:min-h-[600px]">
          ...
          >
            🤖 AI-Powered CRM That Sells For You
          </motion.div>
          ...
          >
            Stop Chasing Leads —{" "}
            <span className="gradient-text">Let AI Close Them For You</span> 🚀
          </motion.h1>
          ...
          >
            You're tired of leads slipping through the cracks. Your team forgets to follow up. 
            Deals go cold. Sound familiar? <span className="text-foreground font-semibold">We built the CRM that fixes all of that — with AI.</span>
          </motion.p>
          ...
          >
            Imagine a CRM that <span className="text-foreground font-semibold">follows up on its own</span>, tells you which leads are hot, 
            analyzes your sales data, and <span className="text-foreground font-semibold">practically runs your sales team</span>. That's what we build at Scalify.
          </motion.p>
        ...
        >
          <div id="contact">
            <h3 className="text-xl font-heading font-bold mb-1 text-center">
              See How AI Can <span className="gradient-text">10x Your Sales</span>
            </h3>
            <p className="text-xs text-muted-foreground text-center mb-4">
              📌 Free consultation. We'll show you exactly what AI can automate for your business.
            </p>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="glass-card p-6 rounded-2xl space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <input name="subject" required type="text" defaultValue="CRM Development Inquiry" placeholder="Subject" className="w-full px-3 py-2.5 rounded-xl bg-secondary border border-border text-foreground placeholder:text-muted-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/50" />
                </div>
                ...
                >
                  {submitting ? "Submitting..." : "Show Me What AI Can Do 🤖"}
                </button>
              </form>
            )}
          </div>
